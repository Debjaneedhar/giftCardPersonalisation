...
<html lang="en">
  ...
  <br/>
    ...
    <div class="container" align="center">
      ...
      <button type="button" class="btn" style="background-color:yellow">Price Adjustment</button>
      <button type="button" class="hideActions btn btn-info" style="background-color:violet">Credit Memo</button>
      ...
      <button type="button" class="hideActions btn btn-success">Cancel Order</button>
      <button type="button" class="hideActions btn btn-info">Return Order</button>
    </div>
    <div>
  ...
  <%-- $(document).ready(function(){
        $( ".hideActions" ).hide();
        var lineStatus = $('.lineStatus').html();
